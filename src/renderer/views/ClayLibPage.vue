<template>
  <div class="clay-lib-page">
    <div class="list-wrapper">
      <draggable class="list" element="ul" v-model="clayLib">
        <transition-group>
          <li class="item" v-for="item in clayLib" :key="item.name" @click="chooseItem(item.name)">
            <div class="item-bg">
              <img :src="item.name | toClayBgUrl">
            </div>
